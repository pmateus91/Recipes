<%@ Page Title="Receitas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="receitas.aspx.cs" Inherits="Recipes.WebForms.Receitas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="jumbotron" style="background-image: url('/docs/images/jumbotron2.jpg'); background-size: cover; background-position: top">
        <h1 class="display-4 text-white font-weight-bold">Receitas</h1>
    </div>
        ...
        <asp:Repeater runat="server" ID="rptRecipe">
            <ItemTemplate>
                    ...
                    <div class="col mb-4">
                        <div class="card">
                            <img src="/docs/images/noimage.png" class="card-img" alt="...">
                            <div class="card-body">
                                ...
                                <p class="card-text"><b>Categoria:</b> <%# DataBinder.Eval(Container.DataItem, "CategoryName").ToString() %></p>
