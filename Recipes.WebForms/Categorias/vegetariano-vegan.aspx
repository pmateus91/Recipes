<%@ Page Title="Grandpa's Recipes - Vegetariano e Vegan" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vegetariano-vegan.aspx.cs" Inherits="Recipes.WebForms.VegetarianaVegan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
      <div class="jumbotron" style="background-image: url('/docs/images/jumbotron2.jpg'); background-size: cover; background-position: top">
        <h1 class="display-4 text-white font-weight-bold">DOCES E SOBREMESAS</h1>
    </div>
